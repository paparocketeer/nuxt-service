<template>
  <aside class="modal" v-show="value">
    ...
    <div class="modal__scroll">
      <div class="modal__body">
        ...
        <p class="text-center">
          Адрес:
          <span>г. Краснодар, ул. Лавочкина, 21</span>
          <br />E-mail:
          <a href="/cdn-cgi/l/email-protection#9dfce5fcf3f9e8eff2ebddf0fcf4f1b3efe8">
            <span
              class="__cf_email__"
              data-cfemail="d2b3aab3bcb6a7a0bda492bfb3bbbefca0a7"
        ...
        <p class="text-center">
          ...
          <br />WhatsApp:
          <a href="https://wa.me/89183536494?text=Я%20заинтересован%20услугами%20ремонта">
            <svg
              width="16"
              height="16"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <form
          ...
          method="POST"
          class="form mt-4 max-w-sm mx-auto"
        >
