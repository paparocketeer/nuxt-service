    ...
    <div class="container">
      <div class="flex -mx-4 lg:-mx-8">
        <div class="content-animated px-4 md:w-1/2 lg:px-8">
          <h2 class="font-bold text-3xl hidden-btm" v-observe-visibility="inView">Ремонты в Краснодаре</h2>
          <p class="mt-8 hidden-btm" v-observe-visibility="inView">
          ...
          <p class="mt-4 hidden-btm" v-observe-visibility="inView">
          ...
          <nuxt-link :to="{path: '/', hash: 'services'}" class="button button_primary mt-8 hidden-btm" v-observe-visibility="inView">Все услуги</nuxt-link>
        </div>
        <div class="px-4 hidden w-1/2 md:block lg:px-8 hidden-right" v-observe-visibility="inView">
          <div class="decor">
            <div aria-hidden="true" class="decor__element"></div>
            <img alt="Ремонты в Краснодаре" :srcset="require('~/assets/img/home/about.jpg').srcSet" class="relative" />
          </div>
        </div>
      </div>
    </div>
