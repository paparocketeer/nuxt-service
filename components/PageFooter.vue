...
<footer class="footer">
        <div class="container flex flex-wrap">
            <div class="footer__block lg:text-left">
                Контактная информация:
                <ul>
                    <li>
                        Телефон:
                        <a href="tel:+78613122122" class="footer__link">
                            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" aria-hidden="true" class="icon">
                                <path
                    ...
                    <li>
                        WhatsApp:
                        <a href="https://wa.me/78613122122?text=Я%20заинтересован%20услугами%20ремонта" class="footer__link">
                            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" aria-hidden="true" class="icon">
                                <path
            ...
            <div class="footer__block lg:text-right">
                <ul>
                    <li>
                        <span class="sr-only">Адрес: </span>
                        <address>г. Анапа, ул. Парковая, 131</address>
                    </li>
                    <li>
                        E-mail:
                        <a href="mailto:mail@remont-861.ru" class="footer__link">
                            <span class="__cf_email__">mail@remont-861.ru</span>
                        </a>
                    </li>
                </ul>
            </div>
            <p class="w-full mt-8 text-xs">
                © 2020
                <strong>Ремонт-861</strong>
                в Анапе
            </p>
        </div>
    </footer>
